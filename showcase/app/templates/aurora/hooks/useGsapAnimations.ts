...
export function useSplitTextAnimation(
  ...
  }, [selector, type, stagger, duration, delay, y, rotateX])
...
export function useParallax(
  ...
  useEffect(() => {
    ...
    return () => ctx.revert()
  }, [selector, yPercent, trigger, start, end])
}
...
export function useStaggeredCards(
  ...
  useEffect(() => {
    ...
    return () => ctx.revert()
  }, [containerSelector, cardSelector, y, stagger, duration, start])
}
