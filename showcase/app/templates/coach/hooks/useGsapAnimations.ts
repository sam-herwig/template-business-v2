 ...
 * @param options - Animation options (should be memoized by caller using useMemo to prevent re-runs)
 */
 ...
 * 
 * @param containerSelector - CSS selector for container element
 ...
 * 
 * @param selector - CSS selector for image elements
 * @param options - Animation options (should be memoized by caller using useMemo to prevent re-runs)
 */
