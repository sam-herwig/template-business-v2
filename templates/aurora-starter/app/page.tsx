...
import { Zap, Palette, RefreshCw, Lock, Smartphone, Rocket, ArrowRight } from 'lucide-react'
  ...
  return (
    <section id="features" className="relative z-10 py-24 md:py-40 px-4 md:px-16" aria-labelledby="features-heading">
      ...
      <motion.div 
        ...
        viewport={{ once: true }}
      >
        <Link href="/features" className="inline-flex items-center gap-2 text-aurora-indigo hover:underline font-medium">
          View all features
