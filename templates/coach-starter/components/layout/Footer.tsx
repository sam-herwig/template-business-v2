      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div className="md:col-span-2">
            <Link href="/" className="font-display text-2xl text-primary-700 block mb-4">
              Sarah Mitchell
            </Link>
            <p className="text-primary-800/60 max-w-sm leading-relaxed">
              Helping ambitious women build businesses that give them freedom, fulfillment, and a really good income.
            </p>
            <div className="flex gap-4 mt-6">
              <a
                ...
                className="w-10 h-10 bg-cream-300 hover:bg-primary-100 rounded-full flex items-center justify-center text-primary-700 transition-colors"
        ...
        <div className="border-t border-cream-300 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-primary-800/50 text-sm">
          ...
          <div className="flex items-center gap-6 text-primary-800/50 text-sm">
            {FOOTER_LINKS.legal.map((link) => (
              <Link key={link.label} href={link.href} className="hover:text-primary-700 transition-colors">
                {link.label}
              </Link>
            ))}
          </div>
